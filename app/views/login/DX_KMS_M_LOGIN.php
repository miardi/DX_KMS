    ...
    <main class="container mt-5">
        <div class="form-signin w-100 m-auto">
            <form method="post" action="<?=BASE_URL."/login/auth"?>">
                <svg class="mb-5" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="158" height="60" viewBox="0 0 139.5 52.9" role="img" aria-labelledby="logo-top" style="fill: rgb(220, 0, 50);">
